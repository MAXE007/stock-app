      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <Card title="Caja (Carrito)" className="lg:col-span-2">
          <div className="flex flex-wrap gap-3 items-center">
            ...
            >
            <option className="bg-neutral-900 text-white" value="CASH">Efectivo</option>
            <option className="bg-neutral-900 text-white" value="TRANSFER">Transferencia</option>
            <option className="bg-neutral-900 text-white" value="MERCADO_PAGO">Mercado Pago</option>
            <option className="bg-neutral-900 text-white" value="DEBIT_CARD">Tarjeta débito</option>
            <option className="bg-neutral-900 text-white" value="CREDIT_CARD">Tarjeta crédito</option>
            <option className="bg-neutral-900 text-white" value="UNSPECIFIED">Sin especificar</option>
            </select>
          </div>
        ...
        <Card title="Historial de ventas">
          {salesLoading ? (
            ...
            <div className="text-white/60">Todavía no hay ventas.</div>
          ) : (
